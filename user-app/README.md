# PsicoUJA User App - Patient Application

This is the mobile-web application for patients in the **PsicoUJA** project. It allows patients to complete daily assessments, communicate with their therapists, and track their well-being.
...
For detailed setup instructions, please refer to the [INSTALL.md](./INSTALL.md) file.
